...
const url = 'https://back-farmacia.onrender.com/api/facturas/';
const clientesUrl = 'https://back-farmacia.onrender.com/api/cliente/';
const empleadosUrl = 'https://back-farmacia.onrender.com/api/empleado/';
const facturaDetalleUrl = 'https://back-farmacia.onrender.com/api/factura_detalle/';
const productoUrl = 'https://back-farmacia.onrender.com/api/producto/';
